...
public class TherapistSharedNotesActivity extends AppCompatActivity
{
    ListView listOfSharedNotes;

    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.therapist_shared_notes_activity);
        this.listOfSharedNotes=findViewById(R.id.therapistSharedNotesList);
        getAllSharedNotes();
    }
    ...
    private void getAllSharedNotes()
    {
        ...
        listOfSharedNotes.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                Intent viewNoteIntent=new Intent(getApplicationContext(), TherapistSharedNoteTakingActivity.class);
