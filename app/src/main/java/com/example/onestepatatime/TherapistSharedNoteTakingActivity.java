...
public class TherapistSharedNoteTakingActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.therapist_shared_note_taking_activity);
        initializeElements();
        ...
        if(this.passedNoteFileName!=null && !this.passedNoteFileName.isEmpty()) {
            ...
            DatabaseReference reference = database.therapistsReference.child(currentUser.getUid()).child("sharedNotes").child(this.passedNoteFileName);
